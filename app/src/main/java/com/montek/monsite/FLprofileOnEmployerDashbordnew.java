...
import static com.montek.monsite.Adapter.CalendarAdapter.curentDateString;
import static com.montek.monsite.Adapter.CalendarAdapter.timearray;
import static com.montek.monsite.Adapter.CalendarAdapter.totalselectedays;
...
import static com.montek.monsite.model.CalendarCollection.date_collection_arr;
import static com.montek.monsite.model.CalendarCollection.date_selected_arr;
public class FLprofileOnEmployerDashbordnew extends AppCompatActivity implements View.OnClickListener {
    ...
    TextView  txv_certification,txv_designation,txv_findustryexp,txv_fdomainexp,txv_fskill,txv_durationtxt,txv_enddate,txv_startdate,txv_duration,txv_totalpaid,edtx_startdate, edtx_enddate, statusreason,txv_gst, txv_rate, txv_ratedur, fdob, faddress, fcategories, fsubcategories, flocation, fname, femail, fcontact, fstatus, fsummary, fskill, findustryexp, fdomainexp, feducation, fexperience;
        ...
        gridview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
                try{
                    ...
                    ((CalendarAdapter) parent.getAdapter()).setSelected(v,position);
                    ((CalendarAdapter) parent.getAdapter()).getPositionList(selectedGridDate, FLprofileOnEmployerDashbordnew.this);
                }catch (Exception e){}
            }
        });
    ...
    public void Activitydatedialog() throws Exception {
        ...
        totalselectedays.clear();
        final Dialog dialog = new Dialog(FLprofileOnEmployerDashbordnew.this, android.R.style.Theme_DeviceDefault_Light_Dialog_NoActionBar_MinWidth);
    ...
    void timestart() throws Exception {
        ...
        mTimePicker = new TimePickerDialog(FLprofileOnEmployerDashbordnew.this, new TimePickerDialog.OnTimeSetListener() {
            @Override
...
//                    Log.d("fruits",fruits1.toString());
            ...
            if(s.contains("No Results Found"))
            {
                ...
                try {
                    ...
                    for (int j = 0; j < jsonArray.length(); j++) {
                        ...
                        txv_gst.setText("(including gst rate)");
                    }
                } catch (Exception e) {  e.getMessage();}
            }
        }
    ...
    class employer_hirefreelancer extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... voids) {
            ...
            params.put("gstapplied", FLprofileOnEmployerDashbordnew.gst);
