...
public class ResetActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onBackPressed() {
        Intent forgotpassword=new Intent(getApplicationContext(),Activity_Login.class);
    ...
    class Reset_Password extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... voids) {
            ...
            return requestHandler.sendPostRequest(URLs.Url_ResetPassword+"SendOTP", params);
        }
        @Override
